...
namespace EShop.Admin
    ...
    public partial class EditUserData : System.Web.UI.Page
        ...
        /// <summary>
        /// Método que carga los datos del cliente parametrizado en función del ID de cliente 
        /// 
        /// </summary>
        /// <param name="userId"></param>
        protected void LoadClientData(object sender, EventArgs e)
            {
            try
                {

                var emailClient = "joanjdoll@hotmail.com";//txtDataEmail.Text;

                ApplicationDbContext context = new ApplicationDbContext();

                UserManager<ApplicationUser> userManager = new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(context));

                ApplicationUser user = userManager.FindByEmail(emailClient);
